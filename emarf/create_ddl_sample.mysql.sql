-- Project Name : emarf
-- Date/Time    : 2017/04/30 15:15:56
-- Author       : oukuf@golorp
-- RDBMS Type   : MySQL
-- Application  : A5:SQL Mk-2

-- 再帰
drop table if exists T_RECURSIVE cascade;

create table T_RECURSIVE (
  RECURSIVE_ID INT AUTO_INCREMENT comment '再帰ID'
  , RRECURSIVE_NM VARCHAR(20) not null comment '再帰名'
  , OYA_RECURSIVE_ID INT comment '親再帰ID'
  ...
  , constraint T_RECURSIVE_PKC primary key (RECURSIVE_ID)
) comment '再帰' ;
