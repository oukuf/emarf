 ...
 * @author oukuf@golorp
 */
public class Radio extends BaseTagSupport implements Valuable {
	...
	public static final String render(final String htmlId, final String htmlName, final String value,
		...
		StringBuilder sb = new StringBuilder("<input type=\"radio\" id=\"").append(htmlId).append("\" name=\"")
	...
	public String doStart() throws JspException {
		...
		return Radio.render(htmlId, htmlName, this.value, checked, readonly);
	}
