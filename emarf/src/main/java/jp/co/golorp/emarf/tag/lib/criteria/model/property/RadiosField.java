 ...
 * @author oukuf@golorp
 */
public class RadiosField extends CriteriaTagSupport implements Propertiable {
	...
	public static String render(final String modelName, final String propertyName, final String htmlName,
			...
			final String optionValue, final String optionLabel, final boolean notnull) {
		...
		sb.append(Radios.render(htmlName, value, readonly, criteria, optionModel, optionValue, optionLabel));
		sb.append("</fieldset>");
		sb.append("</div>");
	 ...
	 *            notnull
	 */
	public RadiosField(final PageContext pageContext, final String modelName, final String propertyName,
	...
	private String callRender() {
		...
		return render(this.modelName, this.propertyName, htmlName, value, readonly, this.getCriteria(),
				this.optionModel, this.optionValue, this.optionLabel, this.notnull);
	}
